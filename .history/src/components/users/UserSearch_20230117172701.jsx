                    ...
                    <form>
                        <div className="form-control">
                            <div className="relative">
                                ...
                                <button type='submit' className="absolute top-0 right-0  bg-[#2a8275] rounded-l-none rounded-r-xl w-36 btn btn-lg" style={{borderTopRightRadius: '0.8rem', borderBottomRightRadius: '0.8rem'}}>Go</button>
                            </div>
                        </div>
                    </form>
                </div>
