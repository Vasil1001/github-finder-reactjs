                    ...
                    <form>
                        <div className="form-control">
                            <div className="relative">
                                ...
                                <button type='submit' className="absolute top-0 right-0 rounded-l-none rounded-r-3xl w-36 btn btn-lg" style={{borderTopRightRadius: '0.8rem', borderBottomRightRadius: '0.8rem'}}>Go</button>
                            </div>
                        </div>
                    </form>
                </div>
