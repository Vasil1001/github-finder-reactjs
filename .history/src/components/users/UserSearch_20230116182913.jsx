                    ...
                    <form>
                        <div className="form-control">
                            <div className="relative">
                                ...
                                <button type='submit' className="absolute top-0 right-0 rounded-l-none rounded-r-3xl w-36 btn btn-lg" style={{borderTopRightRadius: '1rem', borderBottomRightRadius: '1rem'}}>Go</button>
                            </div>
                        </div>
                    </form>
                </div>
