                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-control">
                        <div className="relative">
                            ...
                            />
                            <button type='submit' className="absolute top-0 right-0 align-baseline text-white rounded-l-none rounded-r-xl w-36 btn btn-primary btn-lg" style={{ borderTopRightRadius: '0.92rem', borderBottomRightRadius: '0.92rem' }}>Go</button>
