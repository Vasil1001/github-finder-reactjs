                    ...
                    <form>
                        <div className="form-control">
                            <div className="relative">
                                ...
                                <button type='submit' className="absolute top-0 right-0 rounded-l-none rounded-r-2xl w-36 btn btn-lg" style={{borderTopRightRadius: '0.9rem', borderBotRightRadius: '0.9rem'}}>Go</button>
                            </div>
                        </div>
                    </form>
                </div>
